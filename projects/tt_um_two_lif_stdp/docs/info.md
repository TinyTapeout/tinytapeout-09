...
1. Apply current through ui_in[7:0]
2. Monitor second neuron's state on uo_out[7:0]
3. Observe spikes on uio_out[7:6]
4. View synapse weight on uio_out[5:0]
...
1. Generate regular spikes in first neuron with steady current
2. Observe weight changes on uio_out[5:0]
3. Monitor second neuron's response on uo_out[7:0]
